/**
 * `/tools` pages, from `website.md` section 3.
 *
 ...
 * exist, so the reverse 301s to the alphabetical slug. The title is free to use
 * whichever ordering has more volume; it does not have to match the slug.
 */
...
export const TOOL_PAGES: readonly ToolPage[] = [
  ...
  },
  {
    ...
    answers: "An Indian builder at $25M ARR. Worth using or not.",
    kind: "review",
  },
] as const;
